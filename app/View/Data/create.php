    ...
    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 ">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body py-5 px-md-5">
                ...
                <form method="post" action="/datas/create" class="row g-3">
                    <!--id jenis-->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="id_barang" type="text" class="form-control" placeholder="Masukkan id barang" required>
                    </div>
                    <!--id barang end-->
                    <!--nama barang-->
                    <div class="col-md-12">
                        <label for="nama_barang" class="from-label">Nama barang</label>
                        <input name="nama_barang" type="text" class="form-control" placeholder="Masukkan nama barang" required>
                    </div>
                    <!--nama barang end-->
                    <!--status-->
                    <div class="col-md-12">
