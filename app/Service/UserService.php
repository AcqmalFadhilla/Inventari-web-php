...
class UserService
{
    ...
    {
        if ($request->id == null || $request->email == null || $request->status == null || $request->password == null ||
            trim($request->id) == "" || trim($request->email) == "" || trim($request->password) == "" || trim($request->status) == "") {
            throw new ValidationException("Id, Email, status & Password can not blank");
        }
    }
    ...
    private function validateUserProfileUpdateRequest(UserProfileUpdateRequest $request)
    {
        if ($request->id == null || $request->email == null ||
            trim($request->id) == "" || trim($request->email) == "") {
